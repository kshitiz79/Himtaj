  ...
  return (
    <li className="relative mb-6 sm:mb-0 sm:pl-10">
      <div className="flex items-center">
        <div
          className={`z-10 flex items-center justify-center w-6 h-6 ${iconBgColor} ${iconTextColor} rounded-full shrink-0`}
        >
      ...
      <div className="mt-3 sm:pe-8">
        <h3 className={`font-semibold text-lg ${labelTextColor}`}>{step.label}</h3>
